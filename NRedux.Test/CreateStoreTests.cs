...
namespace NRedux.Test {
    public class CreateStoreTests {
        ...
        public void Passes_Initial_Action_And_Initial_State() {
            var store = Redux<Helpers.Todo[]>.CreateStore(Helpers.TodosReducer, new[] {
                new Helpers.Todo {
                    Id = 1,
                    Message = "Hello"
                }
        ...
        public void Applies_The_Reducer_To_Previous_State() {
            var store = Redux<Helpers.Todo[]>.CreateStore(Helpers.TodosReducer, null);
        ...
        public void Does_Not_Allow_Dispatch_From_Within_Reducer() {
            var store = Redux<Int32>.CreateStore(Helpers.DispatchInMiddleReducer, 0);
        ...
        public void Recovers_From_Error_Within_Reducer() {
            var store = Redux<Int32>.CreateStore(Helpers.ThrowErrorReducer, 0);
